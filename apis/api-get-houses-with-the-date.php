...
WHERE NOT users.email = :sUserEmail AND 1573386547 BETWEEN available_start_date AND available_end_date' );
...
foreach( $aRows as $aRow ){
    $aResults[] = "<a href='#'><div class='white-card'><div class='photo'><img src='$aRow->house_photo_url' alt=''></div><h1>$aRow->house_title</h1><h1>$aRow->house_price</h1></div></a>";
}
