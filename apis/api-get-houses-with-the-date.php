...
foreach( $aRows as $aRow ){
    $aResults[] = "<a href='apartment-view?houseid=$aRow->id'><div class='white-card'><img src='$aRow->house_photo_url' alt=''><div class='house-text'><h5>$aRow->house_title</h5><span class='house-price'>$aRow->house_price kr./night</span></div></div><div class='long-grey-line'></div></a>";
}
